        ...
        <div className={COcontent}>
          ...
          <div className={COcard}>
            ...
            <div className={COcardcontent}>
              ...
              <p>5+ Projects and Relevant Case Studies Through the Program</p>
            </div>
          </div>
          ...
          <div className={COcard}>
            ...
            <div className={COcardcontent}>
              <h4>Doubt Solving</h4>
              <p>
                Weekly Live Sessions of upto 2 hours with Live QnA every week
                for 60 minutes
              </p>
            </div>
          </div>
          <div className={COcard}>
            ...
            <div className={COcardcontent}>
              <h4>Video Content</h4>
              <p>Self Paced Learning with over 20+ hours of Video Content</p>
            </div>
          </div>
          <div className={COcard}>
            <div className={COcardicon}>
